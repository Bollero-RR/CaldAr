...
exports.create = (req, res) => {
  ...
  boilerType.save(boilerType)
    ...
    .catch(err => {
      res.status(500).send({
        message: err.message || "Some error occurred while creating the  boiler type"
      })
    })
}
...
exports.findOneType = (req, res) => {
  BoilerType.findOne({
    ...
    .catch(err => {
      res.status(500).send({
        message: err.message || "Some error occurred while searching the  boiler type"
      })
    })
};
...
exports.update = (req, res) => {
  ...
  BoilerType.findOneAndUpdate({
    ...
    .then(data =>
      res.send({
        message: `boiler type was updated`
      })
    )
    .catch(err => {
      res.status(500).send({
        message: err.message || "Some error occurred while update the  boiler type"
      })
    })
...
exports.delete = (req, res) => {
  ...
  BoilerType.findOneAndRemove({
    ...
    .then(data =>
      res.send({
        message: `boiler type was removed`
      })
    )
    .catch(err => {
      res.status(500).send({
        message: err.message || "Some error occurred while delete the  boiler type"
      })
    })
};